...
from .rig import AindBehaviorImplementationExampleRig
from .task_logic import AindBehaviorImplementationExampleTaskLogic
...
def make_launcher(settings: LauncherCliArgs) -> Launcher:
    ...
    picker = DefaultBehaviorPicker[AindBehaviorImplementationExampleRig, AindBehaviorSessionModel, AindBehaviorImplementationExampleTaskLogic](
